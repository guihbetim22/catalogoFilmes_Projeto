<%--
    Interface de visualização (View) - Listas Pessoais.
    Exibe os títulos marcados pelo usuário autenticado, organizados por 
    categorias como "Já Assisti" e "Quero Assistir".
